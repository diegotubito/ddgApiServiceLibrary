...
public final class ApiRequestConfig: NSObject {
    public var host: String = "staging.fashionedhealth.com"
...
open class ApiRequest {
    ...
    private func getUrl(withPath path: String) -> URL? {
        ...
        urlComponents.queryItems = config.queryItems.map {
    ...
    where TRequest: Encodable {
        ...
        config.body = try? encoder.encode(body)
    }
}
